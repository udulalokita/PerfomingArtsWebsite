// Getting the "tot" value from localStorage and assigning it to the "newtotal" variable
const newtotal = localStorage.getItem("tot");

// Updating the content of the element with the ID "amount" with the value of "newtotal"
document.getElementById("amount").textContent = newtotal;
